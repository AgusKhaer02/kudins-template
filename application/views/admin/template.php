...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <!-- Aos Animation Css -->
      <link rel="stylesheet" href="<?= base_url('assets/admin/')?>vendor/aos/dist/aos.css" />
  ...
  <body class="theme-color-default dark">
	...
	<?php
		$this->load->view('admin/layouts/sidenav');
	?>
	...
	<main class="main-content">
      <div class="position-relative iq-banner">
				...
				?>
				<?php
					$this->load->view('admin/layouts/iq_navbar');
				?>
      <!--Nav End-->
      </div>
    ...
    <script src="<?= base_url('assets/admin/')?>vendor/aos/dist/aos.js"></script>
