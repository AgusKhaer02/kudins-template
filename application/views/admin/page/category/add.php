<div class="card">
	...
	<div class="card-body">
		<form action="<?= site_url('admin/MasterCategories/add_category')?>" method="post" enctype="multipart/form-data"> 
			<div class="form-group">
				<label class="form-label" for="exampleInputText1">Category Name </label>
				<input type="text" class="form-control" id="exampleInputText1" placeholder="template name..." name="category">
			</div>
			<div class="form-group">
